package com.tcc.luan.biob.base_application.model.util;
...
import com.tcc.luan.biob.base_application.control.ColectOnClickListener;
import com.tcc.luan.biob.base_application.control.LearnOnclickListener;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (mode){
            case LEARN_MODE:
                ...
                break;
            case COLECT_MODE:
                layout.setOnClickListener(new ColectOnClickListener(item));
                break;
        }
