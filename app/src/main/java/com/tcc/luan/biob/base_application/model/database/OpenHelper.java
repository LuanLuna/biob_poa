package com.tcc.luan.biob.base_application.model.database;
...
import com.tcc.luan.biob.base_application.model.util.Group;
import com.tcc.luan.biob.base_application.model.util.Item;
import com.tcc.luan.biob.base_application.model.util.Type;
...
public class OpenHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into item_location (item, latitude, longitude) values (1, -7.153213, -34.837247);");

        db.execSQL("insert into item_location (item, latitude, longitude) values (2, -6,8061328, -35,0749378);");
        db.execSQL("insert into item_location (item, latitude, longitude) values (5, -6,8061328, -35,0749378);");
        db.execSQL("insert into item_location (item, latitude, longitude) values (3, -6,8061328, -35,0749378);");
